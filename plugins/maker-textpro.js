...
let name = await conn.getName(who)
 ...
 const fliveLoc2 = {
            ...
            message: { "liveLocationMessage": { "title": "FannBotz","": wm, 'jpegThumbnail': fs.readFileSync('./media/thumb.jpg')}}
           }
 ...
 conn.sendButtonImg(m.chat, result.data, `${tag}, Effect *${effect}nya* Dah Jadi`,``, 'MENU', '.menu', global.fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: sgc,
    mediaType: 2, 
    description: sgc,
    title: "FannBotz",
