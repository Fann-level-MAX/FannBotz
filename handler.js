...
export async function participantsUpdate({ id, participants, action }) {
  ...
  let welcom = 'https://telegra.ph/file/f6708ef4a93e0991fd68c.jpg'

  let godbye = 'https://telegra.ph/file/c95239ac4fe12f58a00d3.jpg'
  
  conn.sendButtonImg(id, await(await fetch(action === 'add' ? wel : lea)).buffer(), ' ', text, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'FannBotz', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
